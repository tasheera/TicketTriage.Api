...
public class GroqService
{
    ...
    - reasoning: one sentence citing the specific words or situation in the ticket that drove the classification. Never just restate the classification or subject line. Bad: "Feature request with no urgency." Good: "Customer explicitly says 'no rush at all', confirming low priority." Bad: "Billing refund requested urgently." Good: "Customer says 'Want my money back today' after cancelling subscription last month."
    """;
